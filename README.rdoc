...
<b>To install as a Rails Plugin:</b>
...
2. Require Fig either explicitly or implicitly.  In a Rails application, I generally do this in environment.rb.
  # implicit
  require 'hopsoft/fig'
  # explicit
  gem 'hopsoft-fig'
3. Instantiate a Fig object that is globally available to your application.  In a Rails application, I generally do this in environment.rb.
  APP_CONFIG = Fig.new(RAILS_ROOT + '/config/app.yml')
4. Start using your settings.
